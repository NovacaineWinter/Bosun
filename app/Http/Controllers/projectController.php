...
class projectController extends Controller
{
	...
	public function newDefaultProject($name){
		...
		$project->can_book_parts_to = 1;	
		$project->can_log_hours = 1;	
		$project->default_task = 0;	
		$project->description = 'Description of project called '.$name ;			
		$project->save();
	...
	public function addTasksToProject($id){
